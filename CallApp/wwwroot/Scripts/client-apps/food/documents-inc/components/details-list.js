Vue.component("details-list", {
    ...
    watch: {
        "details": function (value) {
        	...
        	/*vm.detailsList.forEach(function (item, index) {
        		vm.detailsList[index].CreateDate = vm.detailsList[index].CreateDate.toISOString();
        	})*/
        },

        "detailsList.CreateDate": function (value) {
        	this.detailsList.CreateDate = moment(value).toISOString();
        },

        "detailsList.UseBeforeDate": function (value) {
        	this.detailsList.UseBeforeDate = moment(value).toISOString();
        },
